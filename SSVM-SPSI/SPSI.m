...
%phi-learning SVM
%linear case
function [beta_kp1,Ker_kp1,beta0_kp1]=SPSI(X_l,X_u,Y_l,kernel,...
    VOmega_f,VOmega_g)
% X_l is N_l*p, X_u is N_u*p 
% Y is N_l*1,{-1,1}
% Constant=Inf for Hard Margin
global  precision Cost1 Cost2 Cost3
N_l=size(X_l,1);N_u=size(X_u,1);% p =size(X_l,2)=size(X_u,2)
N=N_l+N_u;
X=[X_l;X_u];
...
%Delta_phi
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% stop here 2016.08.29
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Delta_phi1=zeros(N_l,1);%
